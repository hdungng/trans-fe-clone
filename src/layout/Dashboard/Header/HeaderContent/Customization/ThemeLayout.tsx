          ...
          <FormControlLabel
            ...
            label={
              <MainCard
                ...
                border={false}
                boxShadow
                sx={(theme: Theme) => ({ bgcolor: 'secondary.lighter', p: 1, ...(value === 'default' && { ...activeCardStyle(theme) }) })}
              >
            ...
            <FormControlLabel
              ...
              label={
                <MainCard
                  ...
                  border={false}
                  boxShadow
                  sx={(theme: Theme) => ({ bgcolor: 'secondary.lighter', p: 1, ...(value === 'mini' && { ...activeCardStyle(theme) }) })}
                >
                  <Stack sx={{ gap: 1.25, alignItems: 'center' }}>
