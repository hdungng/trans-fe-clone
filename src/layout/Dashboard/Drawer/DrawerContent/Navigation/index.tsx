...
export default function Navigation() {
  ...
  // Comment out or remove dashboard menu integration to hide the dashboard tab
  // const dashboardMenu = MenuFromAPI();

  useLayoutEffect(() => {
    // Just use the existing menu items without adding dashboard
    setMenuItems({ items: [...menuItem.items] });

    // Original code (commented out to hide dashboard)
    /*
