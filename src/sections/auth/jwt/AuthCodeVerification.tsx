  ...
  return (
    <Formik
      ...
      validationSchema={Yup.object({
        otp: Yup.string().length(4, 'Mã OTP phải gồm đúng 4 chữ số').required('Mã OTP là bắt buộc')
      })}
          ...
          <Grid container spacing={3}>
            ...
            <Grid size={12}>
              <Stack direction="row" sx={{ alignItems: 'baseline', justifyContent: 'space-between' }}>
                <Typography>Bạn không nhận được email? Hãy kiểm tra hộp thư rác hoặc</Typography>
