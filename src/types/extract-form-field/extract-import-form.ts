...
export const generalFormFieldsControl1Import = [
    ...
    { label: 'Số lượng kiện', key: 'general_info.package_quantity', readOnly: false, required: false, type: 'number', method: 'import', options: [] }, // 46
    { label: 'Đơn vị của số lượng kiện', key: 'general_info.package_quantity_unit', readOnly: false, required: false, type: 'comboBox', method: 'import', options: comboBoxData[6].data }, // 47
    { label: 'Tổng trọng lượng hàng (Gross)', key: 'general_info.total_gross_weight', readOnly: false, required: false, type: 'number', method: 'import', options: [] }, // 48
    { label: 'Đơn vị của tổng trọng lượng', key: 'general_info.gross_weight_unit', readOnly: false, required: false, type: 'comboBox', method: 'import', options: comboBoxData[7].data }, // 49
    { label: 'Mã địa điểm lưu kho dự kiến', key: 'general_info.expected_warehouse_location_code', readOnly: false, required: false, type: 'comboBox', method: 'import', options: comboBoxData[8].data }, // 50
    ...
    { label: 'Ngày hàng đến', key: 'general_info.arrival_date', readOnly: false, required: true, type: 'date', method: 'import', options: [] }, // 54
...
export const generalFormFieldsControl2Import = [
    ...
    { label: 'Phân loại hình thức hoá đơn', key: 'general_info_2.invoice_type', readOnly: false, required: false, type: 'comboBox', method: 'import', options: comboBoxData[14].data }, // 13
    ...
    { label: 'Số hoá đơn', key: 'general_info_2.invoice_number', readOnly: false, required: false, type: 'text', method: 'import', options: [] }, // 15
    { label: 'Ngày phát hành', key: 'general_info_2.invoice_issue_date', readOnly: false, required: false, type: 'date', method: 'import', options: [] }, // 16
    { label: 'Phương thức thanh toán', key: 'general_info_2.payment_method', readOnly: false, required: false, type: 'comboBox', method: 'import', options: comboBoxData[15].data }, // 17
...
export const productFormFieldsControlImport = [
    { label: 'Mã hàng', key: 'item_code', readOnly: false, required: false, type: 'text', method: 'import', options: [] },
...
export function validationFormImport(yup: any) {
    return yup.object({
        ...
        general_info: yup.object({
            ...
            arrival_date: yup.date().required('Ngày hàng đến là bắt buộc'),
