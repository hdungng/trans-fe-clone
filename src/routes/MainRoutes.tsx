...
// import FormContractList from 'sections/forms/wizard/list/FormContractList';
import ClientListPage from '../pages/apps/clients/List';
import UserListPage from 'pages/apps/users/List';
import ProtectedRoute from './ProtectedRoute';
import UserAccessControlPage from 'pages/apps/user-access-control/List';
...
const AppJobNumberList = Loadable(lazy(() => import('pages/apps/job-number/List')));
const AppJobNumberAdd = Loadable(lazy(() => import('pages/apps/job-number/Edit')));
const AppJobNumberDetail = Loadable(lazy(() => import('pages/apps/job-number/Detail')));
const AppMasterList = Loadable(lazy(() => import('pages/apps/master-list/List')));
const AppCustomerCard = Loadable(lazy(() => import('pages/apps/customer/card')));
const AppManualUse = Loadable(lazy(() => import('pages/apps/manual-use/MainPage')));
const AppDefaultSetting = Loadable(lazy(() => import('pages/apps/default-setting/MainPage')));
const AppGuideAI = Loadable(lazy(() => import('pages/apps/guide-ai/MainPage')));
const AppHSCode = Loadable(lazy(() => import('pages/apps/hscode/MainPage')));

//user-access-control
// const UserAccessControl = Loadable(lazy(() => import('pages/apps/user-access-control/List')));
      ...
      children: [
        {
          ...
          children: [
            {
              path: 'dashboard',
              element: <ProtectedRoute element={<DashboardDefault />} requiredRole={['Admin', 'Manager']} />,
            },
            // {
            //   path: 'analytics',
          ...
          children: [
            ...
            // },
            {
              ...
              children: [
                {
                  path: 'list',
                  element: <AppJobNumberList />
                },
                {
                  path: 'detail/:id',
                  element: <AppJobNumberDetail />
                },
                {
                  path: 'add',
                  element: <AppJobNumberAdd />
                }
              ]
            },
            {
            ...
            },
            {
              ...
              children: [
                {
                  path: 'list',
                  element: <ProtectedRoute element={<UserListPage />} requiredRole={['Admin', 'Manager']} />,
                  role: "Admin"
                },
              ]
            },
            {
              ...
              children: [
                {
                  path: 'list',
                  element: <ProtectedRoute element={<UserAccessControlPage />} requiredRole={['Admin']} />,
                  role: "Admin"
                },
              ]
            },
